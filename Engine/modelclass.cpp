...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	for (i = 0; i < m_vertexCount; i++)
	{
		...
		if (counter == 0) 
		{
			triangle.vertex[0] = DirectX::SimpleMath::Vector3(preFabVertices[i].position.x, preFabVertices[i].position.y, preFabVertices[i].position.z);
		}
		else if (counter == 1) 
		{
			triangle.vertex[1] = DirectX::SimpleMath::Vector3(preFabVertices[i].position.x, preFabVertices[i].position.y, preFabVertices[i].position.z);
		}
		else if (counter == 2)
		{
			triangle.vertex[2] = DirectX::SimpleMath::Vector3(preFabVertices[i].position.x, preFabVertices[i].position.y, preFabVertices[i].position.z);
		}
